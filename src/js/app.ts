...
class main {
  ...
  _compViewer: Communicator.WebViewer;
  _selectedComponent: string;
  _frameAttachPoints: Map<string, any>;
  _buildSelections: Map<string, string>;
  _componentType: string;
  _selectedComponentName: string;
  ...
  loadModelPreview(modelName: string, transform = undefined): void {
  ...
  setEventListeners(): void {
    ...
    let pillsRefs = pills.getElementsByTagName("a") as HTMLCollection;
    let pillsContent = document.getElementById("pills-tabContent");
    let contentPanes = pillsContent.getElementsByTagName("div");
    let modelThumbnails = pillsContent.getElementsByTagName("a") as HTMLCollection;

    for (let ref of pillsRefs) {

      (<HTMLInputElement>ref).onclick = (e) => {
